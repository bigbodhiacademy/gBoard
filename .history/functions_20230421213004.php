...
function getLeaderboardData() {
  ...
  $query = "SELECT students.name, leaderboard.total_points, leaderboard.average_score
            FROM leaderboard
            INNER JOIN students ON leaderboard.student_id = students.id
            ORDER BY leaderboard.total_points DESC, leaderboard.average_score DESC";
