...
<div class="container">
    ...
    <form action="functions.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="button" class="btn btn-success" id="update-score-btn" value="Update Score" style="display:none">
            <input type="button" class="btn btn-danger" id="delete-score-btn" value="Delete Score" style="display:none">
        </div>
    </form>
