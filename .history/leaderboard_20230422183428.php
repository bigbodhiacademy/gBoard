...
document.getElementById('leaderboardFilterForm').addEventListener('submit', function (event) {
  ...
  console.log("leader filter--",categories);
  console.log("leader y  m i--",year,month,interval);
  ...
  xhr.send(`interval=${interval}&month=${month}&year=${year}&categories=${JSON.stringify(categories)}`);
});
