  ...
  if (isset($_POST['action'])) {
      ...
      switch ($action) {
        ...
        case 'delete_score':
          ...
          case 'update_score':
            $scoreId = intval($_POST['score_id']);
            $category1 = intval($_POST['category1']);
            $category2 = intval($_POST['category2']);
            $category3 = intval($_POST['category3']);
            $category4 = intval($_POST['category4']);
    
            if (updateScore($scoreId, $category1, $category2, $category3, $category4)) {
...
function updateScore($scoreId, $category1, $category2, $category3, $category4) {
  ...
  $stmt = $db->prepare("UPDATE scores SET category1=?, category2=?, category3=?, category4=? WHERE id=?");
