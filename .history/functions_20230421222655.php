...
function getStudentNamesAndAverageScores() {
  ...
  $sql = "SELECT students.name, AVG(scores.category1) as avg_category1, AVG(scores.category2) as avg_category2, AVG(scores.category3) as avg_category3, AVG(scores.category4) as avg_category4 FROM students LEFT JOIN scores ON students.id = scores.student_id GROUP BY students.id";
